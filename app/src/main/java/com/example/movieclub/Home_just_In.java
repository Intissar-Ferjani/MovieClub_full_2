...
public class Home_just_In extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Context context = Home_just_In.this;
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater inflater = LayoutInflater.from(Home_just_In.this);
                ...
                service.execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Adapter smalladapter = new Adapter(Home_just_In.this, arrayList, R.layout.itemposter_small);
                                RecyclerView recyclerView = collectionv.findViewById(id);
                                GridLayoutManager gridLayoutManager = new GridLayoutManager(Home_just_In.this, 3);
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home_just_In.this, Profile.class);
        ...
        mainTab.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                int tabIconColor = ContextCompat.getColor(Home_just_In.this, R.color.md_theme_light_primary);
                if (tab.getIcon() != null) {
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                int tabIconColor = ContextCompat.getColor(Home_just_In.this, R.color.md_theme_light_onPrimary);
                if (tab.getIcon() != null) {
                    tab.getIcon().setColorFilter(tabIconColor, PorterDuff.Mode.SRC_IN);
                }
            }
        ...
        int initcolor = ContextCompat.getColor(Home_just_In.this, R.color.md_theme_light_primary);
        if (homeTab.getIcon() != null) {
            homeTab.getIcon().setColorFilter(initcolor, PorterDuff.Mode.SRC_IN);
        }
        int initcolor1 = ContextCompat.getColor(Home_just_In.this, R.color.md_theme_light_onPrimary);
...
// Instantiate the RequestQueue :.
        ...
        ArrayList<DataClass> arrayList = new ArrayList<>();
        Adapter adapter = new Adapter(Home_just_In.this, arrayList, R.layout.itemposter);
        Adapter smalladapter = new Adapter(Home_just_In.this, arrayList, R.layout.itemposter_small);
        ...
        if (collection.equalsIgnoreCase("Search")) {
            ...
            recyclerView = findViewById(rviewid);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Home_just_In.this, LinearLayoutManager.HORIZONTAL, false);
...
// Request a string response from the provided URL.
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Home_just_In.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
